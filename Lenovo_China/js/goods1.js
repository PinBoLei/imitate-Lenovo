	...
	//加入购物车部分
		$.ajax({
			...
			success:function(res){
				var html ="";
				html = '<span class="operate_stock">'+res[0].stock+'</span><span class="bg_reduce"></span><input type="text" id="buy_number" value="1" /><span class="bg_add"></span><div class="operate_money"><span class="price_unit">RMB</span><span class="span_price">'+ res[0].RMB +'</span></div><div class="div_button_group"><a href="#" class="button-pay">'+ res[0].pay +'</a><a href="shopCart.html" class="button-add" id="'+ res[0].id +'">'+ res[0].add +'</a></div>';
